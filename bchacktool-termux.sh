...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red Anonymous | Mojo$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/Anonymous$tp"
    echo -e $cyan"    Instagram           $white":" $red @anonymous.for.freedom$tp"
    echo -e "$cyan    Twitter            $white : $red https://twutter.com/anonymousnws12$tp"
    echo -e "$cyan    Telegram             $white : $red https://t.me/YourAnonPostNews$tp"
    echo -e "$cyan    Developper         $white : $red https://github.com/Anonymous$tp"
    exit 0
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red Anonymous | Mojo$tp ${blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Telegram             $white":" $red https://t.me/YourAnonPostNews$tp${blink}${lightgreen}      |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Github              $white":" $red https://github.com/Anonymous$tp ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red anonymous.for.freedom$tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo " ~~~~~~~~~~~~~~~~~~~~~ Anonynmous | Mojo ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
        echo " [1] ✔ BluForce-FB" 
        echo " [2] ✔ Cupp" 
        echo " [3] ✔ SpamWa" 
